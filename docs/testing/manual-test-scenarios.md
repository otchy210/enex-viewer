...
- Phase 2 (進行中): `docs/testing/phase2-manual-test-scenarios.md`
- 完了済みフェーズは `docs/archive/phaseN-manual-test-scenarios.md` に順次移動（例: Phase 1 は `docs/archive/phase1-manual-test-scenarios.md`）
